...
namespace AuthService
{
    public class AuthService : IAuthService
    {
        ...
        public ServiceMetadata UpdateUserPassword(string pkcs7Base64, string login)
        {
            //Código do professor:
            SignedCms signedCms = new SignedCms();
            ...
            byte[] pkcs7Encrypted = signedCms.ContentInfo.Content;

            EnvelopedCms envelopedCms = new EnvelopedCms();
            envelopedCms.Decode(pkcs7Encrypted);

            string filepath = AppDomain.CurrentDomain.BaseDirectory + "si.cert.d.pfx";
            ...
            return new ServiceMetadata
            {
                Status = SqlServerHelper.UpdateUserPassword(login, password) == 1,
                Message = "Success"
            };
